...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
                                        ...
                                        if ($result->num_rows > 0) {
                                            while($row = mysqli_fetch_assoc($result)) {
                                            	...
                                            	echo '<div class="blog-post-item">' . '<div class="blog-post-image hover-images">' . '<a href="/24h/user/blog_details.php?id=' . $id . '" title="Post"><img src="/24h/images/' 
                                            		. $id . '">' .'alt=""></a></div>' . '<div class="text">';    
                                                echo '<h3>' . '<a href="/24h/user/blog_details.php?id=' . $id . '">'. $row["title"] .'</a>' .'</h3>';
                                                echo '<p class="post-by"><span><i class="fa fa-pencil-square-o"></i> admin</span></p>';
                                                echo '<p class="content">'. $row["content"]. '</p>';
                                                echo '<a class="link-v1 color-brand" href="/24h/user/blog_details.php?id=' . $id . '">'. 'Read More'. '</a>';
                                                echo '</div></div>';
                                            }
                                        }
                            }
   ...
   <!--                  <div class="blog-post-item">
                        ...
                        <div class="text">                          
                            ...
                            <p class="content">pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. vestibulum tortor quam...</p>
                            <a class="link-v1 color-brand" href="#" title="readmore">read more</a>
                        </div>
                    </div> -->
                </div>
            </div>
